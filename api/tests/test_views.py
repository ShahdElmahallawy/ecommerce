...
def test_category_detail_view(api_client_auth):
    ...
    response = api_client_auth.get(reverse('categories:detail', kwargs={'pk': category.id}))
...
def test_category_update_view(api_admin_auth):
    ...
    response = api_admin_auth.put(reverse('categories:update', kwargs={'pk': category.id}), update_data, format='json')
...
def test_category_delete_view(api_admin_auth):
    ...
    response = api_admin_auth.delete(reverse('categories:delete', kwargs={'pk': category.id}))
...
def test_order_cancel_success(api_client_auth):
    user = User.objects.create_user(name='testuser', password='testpass',email="testuser@example.com")
...
def test_order_cancel_failure(api_client_auth):
    user = User.objects.create_user(name='testuser', password='testpass',email="testuser@example.com")
    another_user = User.objects.create_user(name='anotheruser', password='notcorrect',email="anotheruser@example.com")
...
def test_order_track_unauthorized(api_client_auth):
    user = User.objects.create_user(name='testuser', password='testpass', email="testuser@example.com")
    another_user = User.objects.create_user(name='anotheruser', password='anotherpass', email="anotheruser@example.com")
