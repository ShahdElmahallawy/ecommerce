...
def test_order_total_price_calculation():
    ...
    OrderItem.objects.create(order=order, product=product1, quantity=2, unit_price=10.00)
    OrderItem.objects.create(order=order, product=product2, quantity=1, unit_price=20.00)
